...
1. `A`라는 queryKey를 가진 A 쿼리 인스턴스가 `mount`됨 (get 요청)
...
이 기능들을 언제, 어떻게 사용할지 막막하다면 [튜토리얼 리포지토리](https://github.com/ssi02014/react-query-tutorial)를 보면서 하나하나 사용하며 익히는 방법도 추천한다. (devtools 활용 필수)
